...
//go:generate go run github.com/saltosystems/winrt-go/cmd/winrt-go-gen -debug -class Windows.Storage.StorageFile -method-filter GetFileFromPathAsync -method-filter GetName -method-filter !*
