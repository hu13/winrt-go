...
import (
	...
	// "github.com/saltosystems/winrt-go/windows/storage/search"
...
// func (impl *StorageFolder) GetIndexedStateAsync() (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetIndexedStateAsync()
// }

// func (impl *StorageFolder) CreateFileQueryOverloadDefault() (*StorageFileQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFileQueryOverloadDefault()
// }

// func (impl *StorageFolder) CreateFileQuery(query CommonFileQuery) (*StorageFileQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFileQuery(query)
// }

// func (impl *StorageFolder) CreateFileQueryWithOptions(queryOptions *QueryOptions) (*StorageFileQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFileQueryWithOptions(queryOptions)
// }

// func (impl *StorageFolder) CreateFolderQueryOverloadDefault() (*StorageFolderQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFolderQueryOverloadDefault()
// }

// func (impl *StorageFolder) CreateFolderQuery(query CommonFolderQuery) (*StorageFolderQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFolderQuery(query)
// }

// func (impl *StorageFolder) CreateFolderQueryWithOptions(queryOptions *QueryOptions) (*StorageFolderQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateFolderQueryWithOptions(queryOptions)
// }

// func (impl *StorageFolder) CreateItemQuery() (*StorageItemQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateItemQuery()
// }

// func (impl *StorageFolder) CreateItemQueryWithOptions(queryOptions *QueryOptions) (*StorageItemQueryResult, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.CreateItemQueryWithOptions(queryOptions)
// }

// func (impl *StorageFolder) GetFilesAsync(query CommonFileQuery, startIndex uint32, maxItemsToRetrieve uint32) (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetFilesAsync(query, startIndex, maxItemsToRetrieve)
// }

// func (impl *StorageFolder) GetFilesAsyncOverloadDefaultStartAndCount(query CommonFileQuery) (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetFilesAsyncOverloadDefaultStartAndCount(query)
// }

// func (impl *StorageFolder) GetFoldersAsync(query CommonFolderQuery, startIndex uint32, maxItemsToRetrieve uint32) (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetFoldersAsync(query, startIndex, maxItemsToRetrieve)
// }

// func (impl *StorageFolder) GetFoldersAsyncOverloadDefaultStartAndCount(query CommonFolderQuery) (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetFoldersAsyncOverloadDefaultStartAndCount(query)
// }

// func (impl *StorageFolder) GetItemsAsync(startIndex uint32, maxItemsToRetrieve uint32) (*foundation.IAsyncOperation, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.GetItemsAsync(startIndex, maxItemsToRetrieve)
// }

// func (impl *StorageFolder) AreQueryOptionsSupported(queryOptions *QueryOptions) (bool, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.AreQueryOptionsSupported(queryOptions)
// }

// func (impl *StorageFolder) IsCommonFolderQuerySupported(query CommonFolderQuery) (bool, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.IsCommonFolderQuerySupported(query)
// }

// func (impl *StorageFolder) IsCommonFileQuerySupported(query CommonFileQuery) (bool, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(search.GUIDIStorageFolderQueryOperations))
// 	defer itf.Release()
// 	v := (*search.IStorageFolderQueryOperations)(unsafe.Pointer(itf))
// 	return v.IsCommonFileQuerySupported(query)
// }
...
// func (impl *StorageFolder) TryGetChangeTracker() (*StorageLibraryChangeTracker, error) {
// 	itf := impl.MustQueryInterface(ole.NewGUID(GUIDiStorageFolder3))
// 	defer itf.Release()
// 	v := (*iStorageFolder3)(unsafe.Pointer(itf))
// 	return v.TryGetChangeTracker()
// }
...
// func (v *iStorageFolder3) TryGetChangeTracker() (*StorageLibraryChangeTracker, error) {
// 	var out *StorageLibraryChangeTracker
// 	hr, _, _ := syscall.SyscallN(
// 		v.VTable().TryGetChangeTracker,
// 		uintptr(unsafe.Pointer(v)),    // this
// 		uintptr(unsafe.Pointer(&out)), // out StorageLibraryChangeTracker
// 	)
...
const GUIDiStorageFolderStatics2 string = "b4656dc3-71d2-467d-8b29-371f0f62bf6f"
const SignatureiStorageFolderStatics2 string = "{b4656dc3-71d2-467d-8b29-371f0f62bf6f}"
...
type iStorageFolderStatics2Vtbl struct {
	...
	StorageFolderGetFolderFromPathForUserAsync uintptr
}

func (v *iStorageFolderStatics2) VTable() *iStorageFolderStatics2Vtbl {
	return (*iStorageFolderStatics2Vtbl)(unsafe.Pointer(v.RawVTable))
}

// func StorageFolderGetFolderFromPathForUserAsync(user *system.User, path string) (*foundation.IAsyncOperation, error) {
// 	inspectable, err := ole.RoGetActivationFactory("Windows.Storage.StorageFolder", ole.NewGUID(GUIDiStorageFolderStatics2))
// 	if err != nil {
// 		return nil, err
// 	}
// 	v := (*iStorageFolderStatics2)(unsafe.Pointer(inspectable))
...
// 	}
// 	hr, _, _ := syscall.SyscallN(
// 		v.VTable().StorageFolderGetFolderFromPathForUserAsync,
// 		0,                             // this is a static func, so there's no this
